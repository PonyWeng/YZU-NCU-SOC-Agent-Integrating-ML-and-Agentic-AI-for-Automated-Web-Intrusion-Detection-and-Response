...
OPENAI_API_KEY = "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"
...
def get_openai_summary(text):
    try:
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": "你是一位資安專家，請用50字內摘要這個攻擊事件，並給出最多3點建議。"},
    ...
    for doc in res['hits']['hits']:
        ...
        if alert_id not in notified_alert_ids:
            ...
            for pred_doc in pred_res['hits']['hits']:
                ...
                # 呼叫 OpenAI API 產生摘要
                summary = get_openai_summary(full_message)
